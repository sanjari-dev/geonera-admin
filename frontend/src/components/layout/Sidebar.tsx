...
export default function Sidebar() {
  return (
    <div className="flex h-full w-full flex-col relative z-20 bg-sky-100/80 dark:bg-[#040F1E]">
      ...
      {/* Logo */}
      <div className="flex h-16 flex-shrink-0 items-center gap-3.5 border-b border-sky-200/50 dark:border-sky-900/20 bg-sky-50/45 dark:bg-sky-500/[0.04] px-6">
        ...
        <div className="leading-tight">
          <p className="text-[13px] font-bold tracking-wide text-sky-950 dark:text-sky-50 uppercase">Geonera</p>
      ...
      {/* Footer */}
      <div className="flex-shrink-0 border-t border-sky-200/50 dark:border-sky-900/20 px-6 py-4">
        <div className="flex items-center gap-2 mb-1">
          <div className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse"
            style={{ boxShadow: '0 0 8px rgba(52,211,153,0.8)' }} />
          <p className="text-[10px] font-bold tracking-widest uppercase text-sky-800 dark:text-sky-400/50">System Online</p>
        </div>
        <p className="text-[10px] font-mono text-sky-700/75 dark:text-sky-500/20">v1.0.0-rc.4</p>
      </div>
    </div>
  )
}
